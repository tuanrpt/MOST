...
class AlexNetModel(object):
    ...
    def __init__(self, num_classes=1000, is_training=False, dropout_keep_prob=0.5):
    ...
    def inference(self, x, reuse=None, extract_feat=False):
        with tf.variable_scope('network', reuse=reuse):
            ...
            fc6 = tf.layers.dropout(fc6, rate=1.0-self.dropout_keep_prob, training=self.is_training)
            ...
            fc7 = tf.layers.dropout(fc7, rate=1.0-self.dropout_keep_prob, training=self.is_training)
    ...
    def load_original_weights(self, session, skip_layers=[]):
        ...
        for op_name in weights_dict:
            ...
            with tf.variable_scope('network/' + op_name, reuse=True):
