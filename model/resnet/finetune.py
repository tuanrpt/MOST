...
tf.app.flags.DEFINE_string('training_file', '../data/office_caltech10/amazon.txt', 'Training dataset file')
tf.app.flags.DEFINE_string('val_file', '../data/office_caltech10/amazon.txt', 'Validation dataset file')
