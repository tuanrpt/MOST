...
class ResNetModel(object):
    ...
    def inference(self, x, reuse=None, extract_feat=False):
        # Scale 1
        with tf.variable_scope('scale1', reuse=reuse):
    ...
    def optimize(self, learning_rate, other_var_list, train_layers, loss):
        # all_other_variables = []
        # for var_lst in other_var_list:
        #     for var in var_lst:
        #         all_other_variables += var
        ...
        var_list = [[v for v in tf.trainable_variables() if
            ...
            contains(v.name, train_layers)]] + other_var_list
    ...
    def load_original_weights(self, session, skip_layers=[]):
        ...
        for op_name in weights_dict:
            ...
            var = [v for v in tf.global_variables() if v.name == full_name][0]  # also assign mean, var of each ResNet layer
